...
public class ContasPagarTableModel extends AbstractTableModel {
    ...
    private String[] nomeColunas = {"Código", "Nr Conta", "Fornecedor", "Nr Parcela", "Data Vencimento", "Valor", "Data Pagamento", "Valor Pago"};
...
//        this.leitores.addAll(lista);
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return conta.getFornecedor().getRazaoSocial();
            case 3:
