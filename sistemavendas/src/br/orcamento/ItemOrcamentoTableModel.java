...
public class ItemOrcamentoTableModel extends AbstractTableModel {

    private String[] nomeColunas = {"Ordem", "Código", "Descrição", "Tipo", "Quantidade", "Valor", "Parcial", "Desconto", "Subtotal"};
    private List<ItemOrcamento> produtos;
    ...
    public ItemOrcamentoTableModel(List<ItemOrcamento> lista) {
...
//        this.leitores.addAll(lista);
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ItemOrcamento p = produtos.get(rowIndex);
        switch (columnIndex) {
            case 0:
                return p.getOrdem();
            case 1:
     ...
     public ItemOrcamento getValueAt(int rowIndex) {
        ItemOrcamento p = produtos.get(rowIndex);
        return p;
    }
